...
def gen_too_surveys(
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, GW_gold",
            target_name_base="ToO_GW_gold",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, GW_silver",
            target_name_base="ToO_GW_silver",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, GW_BBH",
            target_name_base="ToO_GW_BBH",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, LensedBNS_large",
            target_name_base="ToO_LensedBNS_large",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48.0,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, LensedBNS_small",
            target_name_base="ToO_LensedBNS_small",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48.0,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            target_name_base="ToO_SSO_night",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=3.0,
    ...
    result.append(
        ToOScriptedSurvey(
            ...
            survey_name="ToO, galacticSN",
            target_name_base="ToO_galacticSN",
            observation_reason=observation_reason,
            science_program=science_program,
            split_long=split_long,
            flushtime=48.0,
